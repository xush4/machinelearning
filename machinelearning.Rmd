...
## Results
1. I built a model using random forest method using 53 variables. This model has an out of sample error rate of **`r paste(round((1-confusion.rf[[3]][1])*100, 2), "%", sep="")`**.
